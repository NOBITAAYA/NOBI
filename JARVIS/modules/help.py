...
HELP_STRING = f"★ 𝕽𝖊𝖆𝖕𝖊𝖗 ʙᴏᴛs ʜᴇʟᴘ ᴍᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @ll_You_Are_Next_ll**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• OWNER •", "https://t.me/ll_You_Are_Next_ll"),
      Button.url("• SUPPORT •", "https://t.me/Fakecenzo_69")
    ]
  ]
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴘᴀʜʟᴇ 𝕽𝖊𝖆𝖕𝖊𝖗 ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 𖤍!! @ll_You_Are_Next_ll", cache_time=0, alert=True)
